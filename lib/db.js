...
const SEED = {
  restaurants: [
    { id: 'r_endivia', name: 'Casa Endivia', cuisine: 'Ensaladas', emoji: '🥗', slots: ['lunch'] },
    { id: 'r_kiddo', name: 'Kiddo', cuisine: 'Hamburguesas', emoji: '🍔', slots: ['lunch'] },
    ...
    { id: 'r_aspen', name: 'Aspen', cuisine: 'Fideos', emoji: '🍝', slots: ['lunch'] },
    { id: 'r_monpoulet', name: 'Mon Poulet', cuisine: 'Pollo', emoji: '🍗', slots: ['lunch'] },
  ],
  votes: [],
  reviews: [],
  dayKey: null,
